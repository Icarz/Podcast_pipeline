...
SYSTEM_PROMPT = (
    ...
    "addiction loops, default-mode hijacking, nervous system dysregulation, cognitive "
    "biases, social conditioning, dopamine traps, identity blind spots. The viewer "
    "discovers they are already inside a system. PROVEN TOP PERFORMERS: "
    ...
    "   TIER 2: A reframe that gives the viewer a new lens on their own behavior — "
    "stoic two-handle choices, identity vs. action distinctions, contrarian principles.\n"
    "   TIER 3: General mindset/discipline wisdom without a hidden-mechanism reveal.\n"
    "   AVOID: inspirational quotes without a reveal, motivational pep-talk clips, "
    "anything that could headline a self-help listicle.\n\n"
