...
COPY_SYSTEM_PROMPT = (
    ...
    "  - Mood: quiet, cozy, a little deadpan/melancholic — never dramatic or "
    "action-packed.\n"
    ...
    "spoken in that quarter (same idea as VIDEO_QUERIES STEP 1), then choose "
    "the wolf's setting and action so it visually MEANS that concept, staged "
    "in an ordinary everyday interior or adjacent exterior (living-room "
    "couch, desk by a window, apartment doorway or hallway, kitchen, "
    "bedroom, balcony/fire escape) — mundane and relatable, never a dramatic "
    "landscape or wilderness scene (that register is for VIDEO_QUERIES stock "
    "footage, not these illustrations).\n"
    "  Example: concept 'you keep choosing the easier path' -> wolf sitting "
    "on a worn couch at night, hand hovering over the TV remote, room dim\n"
    "  Example: concept 'the pain comes later anyway' -> wolf standing at an "
    "apartment window at dusk, arms crossed, watching rain fall\n"
    "  Example: concept 'choose your hard intentionally' -> wolf lacing up "
    "boots by the front door in early morning light, deliberate posture\n"
    "  Example: concept 'brain creates fake scenarios' -> wolf sitting bolt "
    "upright on the couch at night, one lamp lit, staring at nothing, the "
    ...
    "slumped or defeated posture (aspirational or calm-neutral only); no "
    "legible text, signage, or typography anywhere in the image (captions "
    "are composited separately at render time — baked-in text will clash); "
    "no violence or gore; no crowds or extra figures of any kind.\n"
    "Each of the 4 prompts must be one self-contained, vivid sentence "
    "describing the scene, the wolf's action/posture, and the lighting — "
    "written as a full image-generation prompt, not a short search query.\n\n"
